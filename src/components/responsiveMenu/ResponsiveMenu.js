        ...
        <>
            ...
            <div style={toggleState ? {left:0} : {left:'-100%'}} className="responsive-menu overflow-hidden position-fixed bg-white d-block d-md-none">
                ...
                <div className="position-absolute copyright pt-2 bg-white">
                    <p className="o-text-purple text-center mb-2">@2020 GunjiKamiya</p>
                    <p className="o-text-purple text-center mb-2">“Icon made by <a href="https://www.flaticon.com/authors/freepik">Freepik</a> from <a href="https://www.flaticon.com/">www.flaticon.com</a>”</p>
                </div>
            </div>
        </>
    )
